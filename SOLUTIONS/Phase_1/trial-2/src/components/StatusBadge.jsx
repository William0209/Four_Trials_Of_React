...
// Set a default value for variant (should default to 'info' if not provided) syntax {prop ,prop = default}
const StatusBadge = ({ status, variant = "info" }) => {
  ...
  return (
    ...
    <span
      className={`px-3 py-1 text-sm rounded-full ${variantStyles[variant]}`}
    >
