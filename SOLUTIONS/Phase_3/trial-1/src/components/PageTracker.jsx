...
const PageTracker = () => {
  ...
  // Inside: update the title tag to show the current page, `${currentPage} - Archive`, using the document.title, if you're confused on how you update document.title or about what it is, search it up without ai!
  //     <head>
  ...
  useEffect(() => {
    document.title = `${currentPage} - Archive`;
  });
