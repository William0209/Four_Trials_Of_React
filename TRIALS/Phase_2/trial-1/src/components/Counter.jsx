  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      ...
      <div className="flex gap-3 mb-4">
        ...
        {/* Add: appropriate event handler and reference the reset function */}
        <button className="flex-1 px-4 py-2 bg-gray-600 text-white rounded hover:bg-gray-700">
          Reset
        </button>

        {/* Add: appropriate event handler and reference the increment function */}
      ...
      <div className="flex items-center gap-3">
        ...
        {[1, 5, 10].____((____) => (
          <button
            ...
            className={`px-4 py-2 rounded ${____ === ____ ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-700"}`}
          >
            {____}
          </button>
        ))}
