      ...
      <div className="min-h-screen bg-gray-100 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex gap-3 mb-6">
            ...
            <button
              onClick={() => setFilterPriority(____)}
            ...
            {[1, 2, 3].____((priority) => (
              <button
                // Fill in the blank: Use priority as key
                key={____}
                ...
                className={`px-4 py-2 rounded ${filterPriority === ____ ? "bg-blue-600 text-white" : "bg-white text-gray-700"}`}
              >
                Priority {____}
              </button>
            ))}
          ...
          <____ items={____} filterByPriority={____} />
        </div>
      </div>
    </>
  );
